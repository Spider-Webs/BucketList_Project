...
<hr>
<h4>세션 저장소로 DB사용</h4>
<b><a href="https://blog.naver.com/dyko615/222781015633">세션 저장소</a></b><br>
이후 서버 배포등을 활용하기위해서  세션저장소를 DB를 사용하였다. Redis 같은 메모리DB 의경우 별도의 비용이 들기때문에 제일 쉽고 편리한<br>
세션 저장소로 DB를 선택했다.
<hr>
<h4>비밀번호 찾기</h4>
<b><a href="https://blog.naver.com/dyko615/222781529745">이메일을 이용한 비밀번호 찾기</a></b><br>
기존 프로젝트 회원가입과 로그인만 구현을 하였다, 기존 프로젝트 설계 당시 비밀번호를 분실 할 경우 이메일을 통한 비밀번호 찾기를 구현하도록 하였으나<br>
